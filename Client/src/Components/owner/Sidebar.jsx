...
const Sidebar = () => {
    ...
    return (
        <div className='relative min-h-screen md:flex flex-col pt-8 items-center max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
            ...
            {image && (
                <button className='absolute top-0 right-0 p-2 gap-1 bg-primary/10 text-primary cursor-pointer' onClick={updateImage}>Save <img src={assets.check_icon} width={13} alt="" /></button>
            )}
