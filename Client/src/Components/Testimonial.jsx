...
const Testimonial = () => {
    const testimonials = [
        {   id: 1,
            ...
            rating: 5, 
            review: "CarRental made my trip so much easier. The car was delevered right to my door, and the customer service was fantastic!" },
        {   id: 2, 
            name: "Liam Johnson", 
        ...
        {   id: 3, 
            ...
            image: assets.testimonial_image_1, 
            rating: 5, 
            review: "I highly recommand CarRental! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent service." }
    ];
