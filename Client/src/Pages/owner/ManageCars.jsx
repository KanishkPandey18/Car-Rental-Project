...
const ManageCars = () => {
    ...
    const fetchOwnerCars = async () => {
        try {
            ...
            if(data.success){
                ...
                toast.error(data.message); // handle error if needed
            }
        } catch (error) {
    ...
    return (
        <div className="px-4 pt-10 md:px-10 w-full">
            ...
            <TitleOwner title="Manage Cars" subTitle="View all listed cars, update their details, or remove them form the booking platform." />
