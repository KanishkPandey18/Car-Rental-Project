...
const CarDetails = () => {
    ...
    return car ? (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt:px-16'>
            <button onClick={()=>{navigate(-1)}} className='flex items-center gap-2 mt-4 mb-6 text-gray-500 hover:cursor-pointer hover:text-gray-800'>
                    ...
                    <div className='space-y-6'>
                            ...
                            {[
                                ...
                                {icon: assets.users_icon,text:`${car.transmission}`},
                                    ...
                                    <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
                                        <img src={icon} alt="logo" className='h-5 mb-2'/>
                                        <p>{text}</p>
                                    </div>
                                ))}
                        </div>
                        ...
                        <div>
                            ...
                            <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                                {
                                    ["360 Camera","Bluetooth", "GPS", "Heated Seats", "Rear View Mirror"].map((item)=>( <li key={item} className='flex items-center text-gray-500'>
